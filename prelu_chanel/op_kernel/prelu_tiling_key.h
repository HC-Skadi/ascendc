...
#define PRELU_TPL_CHANNEL_NC_SPLIT_C_WEIGHT_REUSE_BY_INNER_MODE 6
#define PRELU_TPL_CHANNEL_NC_WEIGHT_REUSE_BY_INNER_MODE 7
#define PRELU_TPL_CHANNEL_NCL_CONTIGUOUS_MODE 8
...
ASCENDC_TPL_ARGS_DECL(
    ...
    ASCENDC_TPL_UINT_DECL(schMode, 4, ASCENDC_TPL_UI_LIST,
        ...
        PRELU_TPL_CHANNEL_NC_SPLIT_C_WEIGHT_REUSE_BY_INNER_MODE,
        PRELU_TPL_CHANNEL_NC_WEIGHT_REUSE_BY_INNER_MODE,
        PRELU_TPL_CHANNEL_NCL_CONTIGUOUS_MODE));
