...
static PreluTestParam testCases[] = {
    ...
    {"prelu_nc_one_as_scalar", {1, 1, 20000}, ge::DT_FLOAT, ge::FORMAT_ND, {1}, ge::DT_FLOAT, ge::FORMAT_ND,
        ...
        "20000 40 39 512 32 10880 1 1 1 0 0 0 0 0 ", {0}, 64, 262144, 4096},
    ...
    {"prelu_channel_nc_weight_reuse", {64, 3}, ge::DT_FLOAT, ge::FORMAT_ND, {3}, ge::DT_FLOAT, ge::FORMAT_ND,
        ...
        "192 40 0 0 0 9320 3 1 8 1 24 0 0 0 ", {0}, 64, 262144, 4096},
    {"prelu_channel_nc_weight_reuse_small_n", {1, 3}, ge::DT_FLOAT, ge::FORMAT_ND, {3}, ge::DT_FLOAT,
        ...
        "3 1 0 0 0 9320 3 1 8 1 0 0 0 0 ", {0}, 64, 262144, 4096},
    {"prelu_channel_nc_weight_reuse_c33", {2, 33}, ge::DT_FLOAT, ge::FORMAT_ND, {33}, ge::DT_FLOAT,
        ...
        "66 2 0 0 0 9320 33 1 40 1 0 0 0 0 ", {0}, 64, 262144, 4096},
    {"prelu_channel_nc_weight_reuse_nchw_ones", {1, 1024, 1, 1}, ge::DT_FLOAT, ge::FORMAT_ND, {1024},
        ...
        ge::GRAPH_SUCCESS, 4UL, "1024 1 0 0 0 8192 1024 1 1024 1 0 0 0 0 ", {0}, 64, 262144, 4096},
    {"prelu_channel_small_l_weight_reuse", {8, 128, 4}, ge::DT_FLOAT, ge::FORMAT_ND, {128},
        ...
        ge::GRAPH_SUCCESS, 4UL, "4096 8 0 0 0 9216 128 4 512 1 0 0 0 0 ", {0}, 64, 262144, 4096},
    {"prelu_channel_nc_weight_reuse_n13_c47_l19", {13, 47, 19}, ge::DT_FLOAT, ge::FORMAT_ND, {47},
        ...
        ge::GRAPH_SUCCESS, 4UL, "11609 13 0 0 0 8960 47 19 896 1 0 0 0 0 ",
        {0}, 64, 262144, 4096},
    {"prelu_channel_nc_weight_reuse_n100_c197_l31", {100, 197, 31}, ge::DT_FLOAT, ge::FORMAT_ND, {197},
        ge::DT_FLOAT, ge::FORMAT_ND, {100, 197, 31}, ge::DT_FLOAT, ge::FORMAT_ND, "Ascend910B",
        ge::GRAPH_SUCCESS, 4UL, "610700 40 0 0 0 6112 197 31 6112 2 20 0 0 0 ",
        {0}, 64, 262144, 4096},
    {"prelu_channel_small_l_split_c_benefit_low", {1, 2048, 7}, ge::DT_FLOAT, ge::FORMAT_ND, {2048},
        ...
        ge::GRAPH_SUCCESS, 1UL, "14336 40 0 0 0 10880 2048 7 8 51 8 0 0 0 ", {0}, 64, 262144, 4096},
    {"prelu_channel_medium_l_split_c_weight_reuse", {1, 2048, 7, 7}, ge::DT_FLOAT, ge::FORMAT_ND, {2048},
        ...
        ge::GRAPH_SUCCESS, 5UL, "100352 12 0 0 0 184 2048 49 9016 0 0 12 1 0 ", {0}, 64, 262144, 4096},
    {"prelu_channel_l127_c256_split_c_weight_reuse", {128, 256, 127}, ge::DT_FLOAT, ge::FORMAT_ND, {256},
        ge::DT_FLOAT, ge::FORMAT_ND, {128, 256, 127}, ge::DT_FLOAT, ge::FORMAT_ND, "Ascend910B",
        ge::GRAPH_SUCCESS, 5UL, "4161536 40 0 0 0 72 256 127 9144 0 0 4 12 32 ",
        {0}, 64, 262144, 4096},
    {"prelu_channel_l127_c512_split_c_weight_reuse", {128, 512, 127}, ge::DT_FLOAT, ge::FORMAT_ND, {512},
        ge::DT_FLOAT, ge::FORMAT_ND, {128, 512, 127}, ge::DT_FLOAT, ge::FORMAT_ND, "Ascend910B",
        ge::GRAPH_SUCCESS, 5UL, "8323072 40 0 0 0 72 512 127 9144 0 0 8 25 24 ",
        {0}, 64, 262144, 4096},
    {"prelu_channel_nc_split_c_weight_reuse", {1, 70000}, ge::DT_FLOAT, ge::FORMAT_ND, {70000},
        ...
        ge::GRAPH_SUCCESS, 5UL, "70000 9 0 0 0 8160 70000 1 8160 0 0 9 1 0 ", {0}, 64, 262144, 4096},
    ...
    {"prelu_channel_split_benefit_low", {16, 2, 20000}, ge::DT_FLOAT, ge::FORMAT_ND, {2}, ge::DT_FLOAT,
        ...
        "640000 32 0 0 0 10880 2 20000 20000 1 0 2 0 0 ", {0}, 64, 262144, 4096},
