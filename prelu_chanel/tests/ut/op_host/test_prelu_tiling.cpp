...
static PreluTestParam testCases[] = {
    ...
    {"prelu_channel_small_l_weight_reuse_by_inner", {8, 128, 4}, ge::DT_FLOAT, ge::FORMAT_ND, {128},
        ge::DT_FLOAT, ge::FORMAT_ND, {8, 128, 4}, ge::DT_FLOAT, ge::FORMAT_ND, "Ascend910B",
        ge::GRAPH_SUCCESS, 7UL, "4096 8 0 0 0 9216 128 4 512 1 0 0 0 0 ", {0}, 64, 262144, 4096},
    {"prelu_channel_nc_weight_reuse_by_inner_n13_c47_l19", {13, 47, 19}, ge::DT_FLOAT, ge::FORMAT_ND, {47},
        ge::DT_FLOAT, ge::FORMAT_ND, {13, 47, 19}, ge::DT_FLOAT, ge::FORMAT_ND, "Ascend910B",
        ge::GRAPH_SUCCESS, 7UL, "11609 13 0 0 0 9024 47 19 1128 1 0 0 0 0 ",
        {0}, 64, 262144, 4096},
    {"prelu_channel_nc_weight_reuse_by_inner_n100_c197_l31", {100, 197, 31}, ge::DT_FLOAT, ge::FORMAT_ND, {197},
        ge::DT_FLOAT, ge::FORMAT_ND, {100, 197, 31}, ge::DT_FLOAT, ge::FORMAT_ND, "Ascend910B",
        ge::GRAPH_SUCCESS, 7UL, "610700 40 0 0 0 6304 197 31 6304 2 20 0 0 0 ",
        {0}, 64, 262144, 4096},
    ...
    {"prelu_channel_medium_l_split_c_weight_reuse", {1, 2048, 7, 7}, ge::DT_FLOAT, ge::FORMAT_ND, {2048},
        ...
        ge::GRAPH_SUCCESS, 6UL, "100352 12 0 0 0 184 2048 49 9016 0 0 12 1 0 ", {0}, 64, 262144, 4096},
