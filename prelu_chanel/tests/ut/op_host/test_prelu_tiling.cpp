...
static PreluTestParam testCases[] = {
    ...
    {"prelu_channel_nc_weight_reuse_large_c_fallback", {1, 70000}, ge::DT_FLOAT, ge::FORMAT_ND, {70000},
        ge::DT_FLOAT, ge::FORMAT_ND, {1, 70000}, ge::DT_FLOAT, ge::FORMAT_ND, "Ascend910B",
        ge::GRAPH_SUCCESS, 1UL, "70000 40 0 0 0 10880 70000 1 8 1750 0 0 0 0 ", {0}, 64, 262144, 4096},
