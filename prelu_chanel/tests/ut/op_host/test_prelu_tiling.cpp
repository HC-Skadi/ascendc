...
static PreluTestParam testCases[] = {
    ...
    {"prelu_channel_small_l_split_c_weight_reuse", {1, 2048, 7}, ge::DT_FLOAT, ge::FORMAT_ND, {2048},
        ge::DT_FLOAT, ge::FORMAT_ND, {1, 2048, 7}, ge::DT_FLOAT, ge::FORMAT_ND, "Ascend910B",
        ge::GRAPH_SUCCESS, 5UL, "14336 2 0 0 0 1304 2048 7 9128 0 0 2 1 0 ", {0}, 64, 262144, 4096},
