...
{   
    ...
    OperatorDesc opDesc;
    opDesc.AddInputTensorDesc(dataType, out_shape.size(), out_shape.data(), format);
    opDesc.AddInputTensorDesc(dataType, weight_shape.size(), weight_shape.data(), format);
...
{    
    ...
    ReadFile("../input/input_w.bin", fileSize, runner.GetInputBuffer<void>(1), runner.GetInputSize(1));
